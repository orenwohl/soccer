		...
		<div dir="rtl">
			...
			{confirmModal && (
				<div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center">
					<div className="bg-white rounded-lg p-6 max-w-md w-full mx-4 shadow-xl">
						...
						<div className="mb-5">
							<p className="text-gray-700">האם אתה בטוח שברצונך למחוק את יום המשחקים הזה? פעולה זו אינה ניתנת לביטול.</p>
						</div>
						<div className="flex justify-end space-x-2 space-x-reverse">
							<button onClick={cancelDelete} className="bg-gray-300 text-gray-800 px-4 py-2 rounded-md hover:bg-gray-400 transition-colors" disabled={deleteMatch.isPending}>
								ביטול
							</button>
							<button
							...
							>
								{deleteMatch.isPending && <div className="animate-spin rounded-full h-4 w-4 border-b-2 border-white mr-2"></div>}
			...
			<div className="flex justify-between items-center mb-6">
				...
				<div className="flex space-x-2 space-x-reverse">
					<Link href="/matches/generate" className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-md transition-colors">
						יצירת קבוצות
					</Link>
